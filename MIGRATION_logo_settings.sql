-- =====================================================================
-- Migration: Add logo_url to app_settings & setup company_assets storage bucket
-- =====================================================================

-- 1. Add logo_url column to app_settings
ALTER TABLE public.app_settings
  ADD COLUMN IF NOT EXISTS logo_url text;

-- 2. Create storage bucket for company assets/logos if not exists
...
-- 3. Storage bucket policies for company_assets
